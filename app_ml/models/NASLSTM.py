...
class NASLSTM():
    ...
    def __init__(self, input_size, output_size, optimizer= Adam(learning_rate=0.001)):
        ...
        nas_cell = tfa.rnn.NASCell(64)
        self.model.add(layers.RNN(nas_cell, return_sequences=True))
        nas_cell = tfa.rnn.NASCell(32)
        self.model.add(layers.RNN(nas_cell, return_sequences=False))
