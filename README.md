  ...
  <ol>
    ...
    <li>
      ...
      <ul>
        ...
        <li><a href="#installation">εκπαίδευση-του-μοντέλου-LSTM</a>Εκπαίδευση του μοντέλου LSTM</li>
      </ul>
    </li>
...
Στον φάκελο app_ml/train βρίσκεται το αρχείο train_all_models.py. Με την εκτέλεση του αρχείου αυτού πραγματοποιείται η εκπαίδευση όλων των μοντέλων που ορίζονται στον φάκελο app_ml/models, ενώ παράλληλα τυπώνονται και τα αποτελέσματα που επιτεύχθηκαν από το κάθε μοντέλο.
